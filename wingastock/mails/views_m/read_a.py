...
def mail_read_a(request, m_receiver):
    ...
    if m_receiver == 'null':
        ...
        return render(request, 'a/read_message.html', { 'senders': get_senders })
    else:
        ...
        if request.method == 'POST':
                ...
                mail.save()
        return render(request, 'a/read_message.html', 
                {
                    'senders': get_senders,
...
def unreaded_a(request):
    ...
    return render(request, 'a/unreaded.html', 
                  {
                       'senders': get_senders, 
                       'messages': messages, 
...
def readed_a(request):
    ...
    return render(request, 'a/readed.html', 
                  {
                       'senders': get_senders, 
                       'messages': messages, 
                       'search_result': search_content
...
def sent_mails_a(request):
    ...
    return render(request, 'a/sent_mails.html', 
                  {
                       'senders': get_senders, 
                       'messages': messages, 
                       'search_result': search_content
...
# Compose message
@login_required(login_url="login_admin")
def compose_m_a(request, m_receiver):
    ...
    if m_receiver == 'null':
        ...
        return render(request, 'a/compose_m.html', { 'receiver': get_receivers, 'senders': get_senders })
        ...
        if request.method == 'POST':
                ...
                mail.save()
        return render(request, 'a/compose_m.html', 
                    {
...
def delete_mail_a(request, id):
    ...
    return redirect('mail_read_a', m_receiver=m_receiver)


# Delete all mails
@login_required(login_url="login_admin")
def clear_mails_a(request, m_receiver):
